...
@Component({
  selector: 'app-editar-entrevistas-adoptantes',
  templateUrl: './editar-entrevistas-adoptantes.component.html',
  styleUrls: ['./editar-entrevistas-adoptantes.component.css']
})
export class EditarEntrevistasAdoptantesComponent implements OnInit {
